...
## Table of Contents
<ul>
  <li><a href="#">Description, commands</a></li>
  <li><a href="#">How to</a></li>
  <li><a href="#">Options</a></li>
  <li><a href="#">Available methods</a></li>
  <li><a href="#">Event handling</a></li>
	<li><a href="#"><i>Attach method [experimental]</i></a></li>
</ul>
...
***
##### description:
Endow with word completion feature an existing - multiline - edit control.
##### parameters:
. ``_GUIID`` [HWND]
###### description:
> The GUI's HWND.
...
. ``_options`` *OPTIONAL* [OBJECT]
###### description:</br>
> see [options](https://github.com/A-AhkUser/eAutocomplete/blob/master/README.md#options).
##
